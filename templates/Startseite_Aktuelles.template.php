<?php	/* Template Startseite_Aktuelles */

class Startseite_Aktuelles extends Blog {


	protected $blogdir = 121;


	protected function build_submenu( rsContainer $Container, $root=null, $active=null ) {
		$this->docid = 121;
		parent::build_submenu( $Container, $root, $active );
	}	
	...
	protected function build_content( rsContainer $Container ) {
		...
		$Container->subordinate( 'a', array('href' => 'http://www.schulhomepage.de/topliste/index.php?vote=2623') )->subordinate( 'img', array('src' => 'http://www.schulhomepage.de/topliste/bewerten.gif', 'id' => 'schulhomepageawardbanner') );
		$Container->subordinate( 'a', array('href' => 'http://www.schulhomepage.de/topliste/index.php?vote=2623') )->subordinate( 'img', array('src' => 'http://www.schulhomepage.de/topliste/index.php?img=2623&img_id=9', 'id' => 'schulhomepageawardcounter') );
	}
